...
| P-026 Product behavior map and routing system | 3/3 | 3/3 | 3/3 | 1/1 | If portable proof leaks into canonical/root status, active paths are recommended twice, or the queue cannot name one unowned journey, this card fails. |
