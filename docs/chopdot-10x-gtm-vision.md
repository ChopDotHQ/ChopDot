...
### Master-plan alignment (awareness only)

This GTM file stays the 10x strategy/commercial thesis. It now tracks master-plan posture without replacing it.

- **`docs-archive/superpowers/plans/2026-06-17-chopdot-dot-master-execution.md`**: execution spine and completion authority (Programmes A/CAPTURE/B, STATUS BOARD, anti-drift gates).
- **`docs-archive/superpowers/plans/2026-06-20-chopdot-native-friends-iteration.md`**: native friend-friend usability for savings circle / emergency pot / community fund plus falsifier conditions.
- **`docs-archive/superpowers/plans/2026-06-20-chopdot-friend-pilot-readiness.md`**: human comprehension evidence contract (what must pass with real participants).
- **`docs-archive/superpowers/plans/2026-06-20-chopdot-full-product-test-completion-goal.md`**: full flow matrix for spend capture, links, QR, Telegram, webhook-lite, and receipts.
- **`docs-archive/superpowers/plans/2026-06-20-chopdot-escrow-atomicity-lab.md`**: parallel escrow/atomicity experiment area (lab-only, not baseline execution path).

Quick alignment rule:

- **Master plan controls delivery truth.**
- **GTM controls long-range thesis, launch framing, and investor narrative.**
- **Evidence tags used across both:** `pass-local`, `pilot`, `simulated`, `claim-only`, `blocked-live`.
...
1. [Master-plan alignment (awareness only)](#master-plan-alignment-awareness-only)
2. [Part 1: Core State Transitions of the ChopDot Kernel](#part-1-core-state-transitions-of-the-chopdot-kernel)
3. [Part 2: PRD — Card Issuer Adapter](#part-2-product-requirements-document-prd--card-issuer-adapter)
4. [Part 3: Developer Setup Guide — Simulating the 1.5-Second RTA Loop](#part-3-developer-setup-guide--simulating-the-15-second-rta-loop)
5. [Part 4: Relational Database Schema Architecture](#part-4-relational-database-schema-architecture)
6. [Part 5: Mobile UI Screens & User Flows](#part-5-mobile-ui-screens--user-flows)
7. [Part 6: Launch Budget Matrix & Operational Costs](#part-6-launch-budget-matrix--operational-costs)
8. [Part 7: Investor Pitch Deck Script](#part-7-investor-pitch-deck-script)
9. [Part 8: Smart Contract Technical Specifications](#part-8-smart-contract-technical-specifications)
10. [Part 9: User Terms of Service (ToS) Compliance Outline](#part-9-user-terms-of-service-tos-compliance-outline)
11. [Part 10: Webhook API Security Protocol](#part-10-webhook-api-security-protocol)
12. [Part 11: Automated API Security Testing Suite](#part-11-automated-api-security-testing-suite)
13. [Part 12: Customer Support Scripts for Core Edge Cases](#part-12-customer-support-scripts-for-core-edge-cases)
14. [Part 13: GitHub Actions CI/CD Pipeline Security Gate](#part-13-github-actions-cicd-pipeline-security-gate)
15. [Part 14: Merchant API Onboarding Documentation](#part-14-merchant-api-onboarding-documentation-b2b_qr_integrationmd)
16. [Part 15: Internal Milestone Schedule (6-Month Sprint Allocation)](#part-15-internal-milestone-schedule-6-month-sprint-allocation)
17. [Part 16: Seed Fundraising Tracker](#part-16-seed-fundraising-tracker)
18. [Part 17: Net-Positive Exchange Checklist](#part-17-net-positive-exchange-checklist-why-this-is-a-no-brainer)
19. [Part 18: Conformance Matrix (Vision vs Current ChopDot Setup)](#part-18-conformance-matrix-vision--current-chopdot-setup)
20. [Part 19: What to do to move from 5.5/10 to 8/10](#part-19-what-to-do-to-move-from-55-10-to-8-10)
21. [Part 20: Unified Framework Integration](#part-20-unified-framework-integration-final-consolidation)
22. [Part 21: Multi-Surface Omnipresent Architecture](#part-21-multi-surface-omnipresent-architecture)
23. [Part 22: Unified API Payload Routing Specification](#part-22-unified-api-payload-routing-specification)
24. [Part 23: Cross-Chain Smart Contract Migration Guide](#part-23-cross-chain-smart-contract-migration-guide)
25. [Part 24: Growth & User Acquisition Playbook](#part-24-growth--user-acquisition-playbook)
26. [Part 25: Full System Blueprint Summary](#part-25-full-system-blueprint-summary)
27. [Part 26: Institutional Seed Round Term Sheet Checklist](#part-26-institutional-seed-round-term-sheet-checklist)
28. [Part 27: Core Dashboard Analytics Architecture](#part-27-core-dashboard-analytics-architecture)
29. [Original positioning anchors for comparison](#original-positioning-anchors-for-comparison)
