...
- `docs/CELL_SYSTEM_CHOPDOT_ALIGNMENT_DEEP_DIVE.md`
- `docs/LONG_TERM_TRUST_LAYER_ECONOMICS.md`
- `docs/PROTOCOL_DURABILITY_AND_ORGANIC_GROWTH_RESEARCH.md`
- `docs/GROUP_COMMITMENT_RESEARCH_PROGRAM.md`
- `docs/RIGOR_AND_EVIDENCE_OPERATING_MODEL.md`
- `docs/RESEARCH_AND_PROOF_STANDARDS_AUDIT.md`
- `docs/TRUST_BOUNDARY_AND_SECURITY_POLICY.md`
- `docs/AUTHORITY_MODEL_AND_ROLE_POLICY.md`
- `docs/ECOSYSTEM_IMPACT_DASHBOARD_REQUIREMENTS.md`
- `docs/CLAIMS_AND_EVIDENCE_LEDGER.md`
- `docs/SCIENTIFIC_VALIDATION_FRAMEWORK.md`
- `docs/HUMAN_MECHANISMS_EXPERIMENT_PROGRAM.md`
- `docs/FUTURE_DEVELOPMENT_STRESS_TEST_MATRIX.md`
- `docs/EXPERIMENT_LOG_TEMPLATE.md`
- `docs/JOINED_VS_COMMITTED_TEST_PLAN.md`
- `docs/AUTOBOTS_RESEARCH_OS_LESSONS_FOR_CHOPDOT.md`
- `docs/CHOPDOT_HARD_QUESTIONS_RESEARCH_MAP.md`
- `docs/PRIVACY_PERSONHOOD_AND_NO_KYC_RESEARCH_PROGRAM.md`
- `docs/ASSURANCE_LEVEL_POLICY.md`
- `docs/NO_KYC_ABUSE_MODEL.md`
- `docs/COMMITMENT_METRICS_AND_10X_SCORECARD.md`
- `docs/COMMITMENT_SYSTEMS_COMPARATIVE_BENCHMARK.md`
- `docs/FRONTIER_SECURITY_AND_RELIABILITY_RESEARCH.md`
- `docs/FRONTIER_IDENTITY_PRIVACY_AND_AUTHORITY_RESEARCH.md`
- `docs/OPEN_SYSTEM_SUSTAINABILITY_AND_GROWTH_MECHANISMS.md`
- `docs/GROUP_COORDINATION_BEHAVIOR_FRONTIER_RESEARCH.md`
- `docs/ZAMA_STYLE_GTM_LESSONS_FOR_CHOPDOT.md`
