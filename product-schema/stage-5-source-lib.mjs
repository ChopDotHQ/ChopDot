...
export function parseMarkdownEvents(text,path){
  ...
  for(const line of text.split(/\r?\n/)){
    ...
    const looksEvent=v=>/(Requested|Opened|Viewed|Selected|Prepared|Confirmed|Removed|Verified|Returned|Saved|Closed|Submitted|Cleared|Started|Accepted|Retried|Refreshed|Cancelled|Reported|Recorded|Added|Withdrawn|Created|Delivered|Resolved|Checked|Failed|Unknown|Previewed)$/.test(v)||/^Demo[A-Z]/.test(v);
