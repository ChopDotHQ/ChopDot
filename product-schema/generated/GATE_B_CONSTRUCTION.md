...
- **DEC-EXPENSE-SETTLEMENT-LOCK-01** — approved 2026-09-22; resolves POLICY-EXPENSE-LOCK-SCOPE
...
- **REQ-J05-LOCK** (effect_guard): {"policy":"dependency_scoped_with_explicit_group_closeout","ordinary_settlement_create":"allow_unrelated_new_expense","group_closeout_create":"block_for_closeout_group","entered_details_preserved_if_blocked":true}
...
- **REQ-J06-LOCK** (effect_guard): {"policy":"dependency_scoped_with_explicit_group_closeout","ordinary_settlement_edit_delete":"block_if_target_expense_in_active_scope_source_item_ids","unrelated_expense_edit_delete":"allow","group_closeout_edit_delete":"block_for_closeout_group","unknown_effect":"keep_relevant_scope_locked_until_reconciled"}
