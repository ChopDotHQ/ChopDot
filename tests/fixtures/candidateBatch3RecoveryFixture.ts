...
export async function candidateBatch3DinnerEvents(): Promise<CanonicalEventV1[]> {
  const rows: Array<Omit<CanonicalEventInput, 'groupId' | 'occurredAt'>> = [
    ...
    {eventId:'03-request-leo',commandId:'c3',expectedVersion:2,parentEventId:'02-expense',actorId:'mina',actorAccountPublicKeyHex:b3MinaKey,actorRole:'organizer',eventType:'SHARE_REQUESTED',payload:{shareId:'share:e1:leo'}},
    {eventId:'04-request-nina',commandId:'c4',expectedVersion:3,parentEventId:'03-request-leo',actorId:'mina',actorAccountPublicKeyHex:b3MinaKey,actorRole:'organizer',eventType:'SHARE_REQUESTED',payload:{shareId:'share:e1:nina'}},
    {eventId:'05-paid-leo',commandId:'c5',expectedVersion:4,parentEventId:'04-request-nina',actorId:'leo',actorAccountPublicKeyHex:b3LeoKey,actorRole:'member',eventType:'SHARE_MARKED_PAID',payload:{shareId:'share:e1:leo'}},
    {eventId:'06-received-leo',commandId:'c6',expectedVersion:5,parentEventId:'05-paid-leo',actorId:'mina',actorAccountPublicKeyHex:b3MinaKey,actorRole:'organizer',eventType:'SHARE_RECEIVED',payload:{shareId:'share:e1:leo'}},
    {eventId:'07-paid-nina',commandId:'c7',expectedVersion:6,parentEventId:'06-received-leo',actorId:'nina',actorAccountPublicKeyHex:b3NinaKey,actorRole:'member',eventType:'SHARE_MARKED_PAID',payload:{shareId:'share:e1:nina'}},
    {eventId:'08-received-nina',commandId:'c8',expectedVersion:7,parentEventId:'07-paid-nina',actorId:'mina',actorAccountPublicKeyHex:b3MinaKey,actorRole:'organizer',eventType:'SHARE_RECEIVED',payload:{shareId:'share:e1:nina'}},
