...
function clearPending(n){n.pendingSubject=null;n.pendingMethod=null;n.pendingRequest=0;n.pendingChallenge=0;n.pendingDestination=null;}
function clearVerified(n){n.verified=false;n.verifiedSubject=null;n.verifiedMethod=null;n.verifiedRequest=0;n.verifiedChallenge=0;n.verifiedDestination=null;}
function invalidateAuthority(n,{rotate=false,clearPendingAuthority=true}={}){if(rotate)n.request++;clearVerified(n);if(clearPendingAuthority)clearPending(n);}
function verificationCurrent(n){
 const subject=currentSubject(n);
 return !!(n.verified&&subject&&n.verifiedSubject===subject&&n.verifiedMethod===n.method&&n.verifiedRequest===n.request&&n.verifiedDestination===n.destination&&(n.method!=='email'||n.verifiedChallenge===n.challenge));
}
function initial(){return {route:'welcome',destination:'home',email:'',name:'',method:null,account:null,verified:false,isNew:true,challenge:0,expired:false,online:true,approval:'none',request:0,expectedIdentity:null,error:'',notice:'',events:[],joined:false,pendingSubject:null,pendingMethod:null,pendingRequest:0,pendingChallenge:0,pendingDestination:null,verifiedSubject:null,verifiedMethod:null,verifiedRequest:0,verifiedChallenge:0,verifiedDestination:null};}
function apply(s,event,payload={}){
 const n=JSON.parse(JSON.stringify(s)); n.error='';n.notice='';
 const emit=(type,authority='person',subject=currentSubject(n))=>n.events.push({type,authority,destination:n.destination,challenge:n.challenge,request:n.request,subject:subject||null,verified_subject:n.verifiedSubject||null});
 ...
 case 'SEND_CODE':{
  ...
  n.request++;n.challenge++;n.expired=false;n.method='email';n.approval='none';clearVerified(n);
  n.pendingSubject=emailSubject(n.email);n.pendingMethod='email';n.pendingRequest=n.request;n.pendingChallenge=n.challenge;n.pendingDestination=n.destination;
  n.route='code';emit('SignInCodeRequested','person',n.pendingSubject);break;}
 case 'VERIFY_CODE':{
  ...
  n.verified=true;n.verifiedSubject=n.pendingSubject;n.verifiedMethod='email';n.verifiedRequest=n.pendingRequest;n.verifiedChallenge=n.pendingChallenge;n.verifiedDestination=n.pendingDestination;
 ...
 case 'RESEND':
  ...
  if(!n.online){n.route='offline';break;}
  n.request++;n.challenge++;n.expired=false;clearVerified(n);n.pendingSubject=emailSubject(n.email);n.pendingMethod='email';n.pendingRequest=n.request;n.pendingChallenge=n.challenge;n.pendingDestination=n.destination;n.notice='New code sent. Use the latest one.';emit('SignInCodeRequested','person',n.pendingSubject);break;
 case 'PROFILE':
 ...
 case 'APPROVAL_RESULT':{
  ...
  if(payload.result==='approved'){
   ...
   n.verified=true;n.verifiedSubject=n.pendingSubject;n.verifiedMethod='wallet';n.verifiedRequest=n.pendingRequest;n.verifiedChallenge=0;n.verifiedDestination=n.pendingDestination;n.approval='verified';n.isNew=n.account!=='Everyday';n.name=n.isNew?'':'Dev';n.route=n.isNew?'profile':'ready';emit('SessionVerified','demo-provider',n.verifiedSubject);
