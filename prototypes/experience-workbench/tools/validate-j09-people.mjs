...
const locks=json('registry/golden-artifact-locks.json');assert.equal(locks.length,11);
...
console.log('J09 PEOPLE GATE PASSED: 67 model assertions, 32 exact-artifact browser scenarios, 110 clicks, 36 layouts; 11 Goldens unchanged.');
