...
const j18HistoryPath=path.join(root,'journeys/18-activity-notifications/source/decision-history.md');assert(fs.existsSync(j18HistoryPath),'Canonical J18 decision history must exist before legacy bundle replay');const canonicalJ18History=fs.readFileSync(j18HistoryPath,'utf8');assert(canonicalJ18History.includes('**Coverage:**'),'Canonical J18 decision history must use current structured format');
...
console.log('Materialized exact J18 V1.1 Golden candidate support and J19 V1 review candidate; canonical J18 decision history preserved.');
