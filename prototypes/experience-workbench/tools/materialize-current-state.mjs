...
const manifestPath='registry/j18-candidate.json';
...
if(candidate){
  ...
  const j=journeys.find(x=>x.id==='18');
...
if(goldenCount!==17) throw new Error(`Expected 17 Goldens, got ${goldenCount}`);
if(locks.length!==17) throw new Error(`Expected 17 Golden locks, got ${locks.length}`);
