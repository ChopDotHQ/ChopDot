...
if(!exists(j21Path)||!exists(approvalCheckpoint)) throw Error('Missing approved J21 bytes or approval checkpoint');
...
Object.assign(j21,{status:'golden',approval:'design-approved',version:'v1',spec_path:'journeys/21-wallet-crypto/spec.md',prototype_path:j21Path,prototype_sha256:j21Sha,golden_number:21,approved_on:approvedOn});
...
write('registry/approvals/21-v1.json',{
  ...
  prototype_path:j21Path,prototype_sha256:j21Sha,html_change_authorized:false,human_approval_surface:'issue #38',human_approval_comment_id:'5634082954',
