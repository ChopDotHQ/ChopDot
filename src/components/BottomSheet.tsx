...
export function BottomSheet({ isOpen, onClose, title, children }: BottomSheetProps) {
  ...
  return (
    <div className="absolute inset-0 flex flex-col justify-end" style={{ zIndex: 70 }}>
      <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={onClose} />
      <div className="relative w-full bg-card rounded-t-[var(--r-2xl)] shadow-[var(--shadow-card)] flex flex-col" style={{ maxHeight: '92%', minHeight: '500px', paddingBottom: 8 }}>
