...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  let baseClass = 'font-semibold rounded-full transition-colors shadow-sm focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center';
  let variantClass = '';

  switch (variant) {
    case 'primary':
      baseClass = 'py-4 font-semibold rounded-full transition-colors shadow-sm focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center';
    ...
    case 'danger':
      ...
      break;
    case 'muted':
      baseClass = 'py-2 font-semibold transition-colors focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center';
      variantClass = 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 shadow-none';
      break;
    case 'icon':
      baseClass = 'p-2 rounded-full transition-colors focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center';
