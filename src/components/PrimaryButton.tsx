...
export function PrimaryButton({ children, onClick, disabled, fullWidth, variant = "default", loading = false, ...props }: PrimaryButtonProps) {
  const handleClick = () => {
  ...
  if (variant === "gradient") {
    return (
      <button
        ...
        onClick={handleClick}
        disabled={isDisabled}
        className={`px-4 py-2.5 rounded-[var(--r-lg)] transition-all duration-200 text-body text-center flex items-center justify-center gap-2 ${isDisabled
