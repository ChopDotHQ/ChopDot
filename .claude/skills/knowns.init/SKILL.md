...
### Step 2: Read Cross-IDE Context (if available)

**Check for active session state from previous session (any IDE):**

Read `.knowns/docs/active-context.md` if it exists — this contains:
- What was done last session and in which IDE
- What's in progress and what's next
- Active decisions and blocked items
- Key context the last agent left for you

Also read `CLAUDE.md` at the project root — it contains inlined core directives and project intelligence.
